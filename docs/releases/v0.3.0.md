...
> **Archived release report for 0.3.0.** It describes the system as it stood at that release and is not updated. For current state see [docs/mobile/README.md](../mobile/README.md).
...
- Full-repository incompatibility audit in [`docs/mobile/architecture.md`](../mobile/architecture.md).
